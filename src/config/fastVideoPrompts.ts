...
[第 14-15 秒] 极速快切。一个眼神犀利、带着机械臂的男人（类似杰特·布莱克 Jet Black）一脚踢开生锈的金属舱门。他咧嘴一笑，气场全开地大吼一声，同时屏幕上伴随着极具视觉冲击力的粗体字幕闪烁：“吃饭了！”`,
    requirements: [
      ...
      'For storyboard image prompts, choose 1-2 anchor frames that can support this fast-cut progression instead of trying to literalize every beat as a separate still.',
  ...
  plan: {
    ...
    tasks: [
      'Decide whether the idea should use 1 or 2 storyboard scenes.',
      'Write storyboard image prompts that are optimized for still-image generation, not video generation.',
      'If there are 2 scenes, make scene 2 explicitly preserve continuity from scene 1.',
    ...
    outputRequirements: [
      ...
      'imagePrompt and videoPrompt should be professional English prompts optimized for model execution.',

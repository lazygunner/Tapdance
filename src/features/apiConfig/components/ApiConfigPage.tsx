            ...
            <section key={providerId} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              ...
              <div className="space-y-4">
                ...
                {providerId === 'volcengine' && (
                  <div className="rounded-xl border border-zinc-800 bg-zinc-950 p-4">
                    <div className="mb-4">
                      <p className="text-xs font-semibold text-zinc-300">Seedance 2.5 / 2.0 任务 API</p>
                      <p className="mt-1 text-xs leading-5 text-zinc-500">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <label className="block">
                        <span className="text-xs font-semibold text-zinc-500 uppercase tracking-wider">Seedance 2.5 模型</span>
                        <input
                          value={apiSettings.seedance.seedance25ApiModel}
                          onChange={(event) => setApiSettings((prev) => ({
                            ...prev,
                            seedance: { ...prev.seedance, seedance25ApiModel: event.target.value },
                          }))}
